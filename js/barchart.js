...
barChart.globalXScale   = undefined;
...
barChart.preDefScales = function(){
...
//DOMObj, width, height, margin, xAxis, yAxis, xAxisLabel, yAxisLabel, 
    ...
    barChart.dataset = dataGenerator.generateData(yearSelected);
    barChart.preDefScales();
    
    var mainSVG = barChart.appendSVG("#histogram");
